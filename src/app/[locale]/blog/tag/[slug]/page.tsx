...
export default function BlogTagPage({ 
  ...
  // In a real implementation, you would fetch the tag and posts data from your API
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-8">
          <div className="mb-8">
            <h1 className="text-3xl font-bold mb-2">{t('postsTaggedWith')}</h1>
            <div className="inline-block px-3 py-1 bg-primary/10 text-primary rounded-full text-lg">
              {tag.name}
            </div>
          </div>
          ...
          <BlogList 
            ...
            totalPages={2}
            baseUrl={`/${params.locale}/blog/tag/${params.slug}`}
          />
        </div>
